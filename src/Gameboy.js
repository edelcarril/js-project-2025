...
const GameBoy = ({ children }) => {
  return (
    ...
    <section className="relative w-[400px] h-[550px] z-0">    
        ...
        <div className="z-40 w-[400px] h-[550px] bg-slate-900 rounded-xl  p-6 flex flex-col gap-2 font-mono text-gray-400">
          {/* Pantalla */}
          <div className="relative flex-1">
            {/* Div para el borde con gradiente hacia dentro */}
            <div className=" bg-opacity-0 w-full h-full shadow-[0_0_15px_rgba(74,222,128,0.2)]">
            ...
            <div className="relative flex-1 h-full flex items-center border-2 border-green-950 justify-center bg-gradient-to-b from-green-400 to-green-500 text-black text-sm">
          ...
          <div>
            ...
            <div className="flex w-32 justify-center">
              <button className="w-16 h-6 rounded-[3px] bg-gray-800 shadow-md text-xs">Start</button>
            </div>
            {/* Botones ABXY */}
            <div className="flex gap-4 items-center">
              <div className="flex flex-col gap-4">
                <button className="w-8 h-8 text-xs rounded-full bg-gray-800 shadow-lg">X</button>
